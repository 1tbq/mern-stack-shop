...
sgMail.setApiKey('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');
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'onetariq@gmail.com', // admin
            from: 'noreply@tariq.pro.com',
...
exports.updateOrderStatus = (req, res) => {
    //we find the order already because we have orderId in params and 
    //which is midddleware
